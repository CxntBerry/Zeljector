...
int main()
{
    ...
    const char* dll_name = "dlltesting.dll"; // name of ur dll
    const char* window_title = "Untitled - paint.net 4.2.7"; // exact name of ur window
    ...
    if (proc_id == NULL)
    {
        error("get_proc_id", "Failed to get proccess ID");
    }
    ...
    MessageBox(0, "Success", "Successfully injected", 0);
